...
public class RShoulderMov : MonoBehaviour
{
    ...
    void OnEnable()
    {
        UnityServer.OnRightShoulderSensorDataReceived += HandleSensorDataReceived;
    }
    ...
    void Update()
    {
        // Apply the sensor data with offset to the transform's rotation
        transform.localRotation = Quaternion.Euler(sensorData + offset);
    }
